        ...
        <header>
            <ul id="slide-out" className="side-nav hidden custom-scrollbar sn-bg-2 ps ps--theme_default" data-ps-id="c27390a3-9efc-e0d8-197a-ab96d73a156a">
                ...
                <li>
                    <ul className="social">
                        <li>
                            <a className="icons-sm fb-ic" href='http://localhost:3000/'>
                                <i className="fa fa-facebook"> </i>
                            </a>
                        </li>
                        <li>
                            <a className="icons-sm pin-ic" href='http://localhost:3000/'>
                                <i className="fa fa-pinterest"> </i>
                            </a>
                        </li>
                        <li>
                            <a className="icons-sm gplus-ic" href='http://localhost:3000/'>
                                <i className="fa fa-google-plus"> </i>
                            </a>
                        </li>
                        <li>
                            <a className="icons-sm tw-ic" href='http://localhost:3000/'>
                ...
                <li>
                    ...
                    <ul className="collapsible collapsible-accordion">
                        <li>
                            <a className="collapsible-header waves-effect arrow-r" href='http://localhost:3000/'>
                        ...
                        <li className="active">
                            <a className="collapsible-header waves-effect arrow-r active" href='http://localhost:3000/'>
            ...
            <nav className="navbar fixed-top navbar-toggleable-md navbar-expand-lg navbar-dark scrolling-navbar double-nav">
                ...
                <div className="float-left">
                    <a data-activates="slide-out" className="button-collapse" href='http://localhost:3000/'>
                ...
                <ul className="nav navbar-nav nav-flex-icons ml-auto">
                    <li className="nav-item dropdown">
                        <a className="nav-link dropdown-toggle waves-effect waves-light" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false" href='http://localhost:3000/'>
                            <i className="fa fa-user"></i> Tài Khoản</a>
                        <div className="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu1">
                            <a className="dropdown-item waves-effect waves-light" href='http://localhost:3000/'>Đăng Ký</a>
                            <a className="dropdown-item waves-effect waves-light" href='http://localhost:3000/'>Đăng Nhập</a>
                            <a className="dropdown-item waves-effect waves-light" href='http://localhost:3000/'>Đăng Xuất</a>
                        </div>
                    </li>
                </ul>
